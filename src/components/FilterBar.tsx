    ...
    <div className="bg-white/80 backdrop-blur-xl p-5 rounded-2xl shadow-lg shadow-gray-200/40 border border-white/60 mb-8 flex flex-col md:flex-row gap-5 items-end">
      ...
      <div className="flex gap-3 w-full sm:w-auto mt-4 sm:mt-0 md:ml-auto">
        <button
          ...
          className="px-5 py-2.5 border border-gray-200 shadow-sm text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all flex items-center cursor-pointer"
        >
        ...
        <button
          ...
          className="px-5 py-2.5 border border-transparent shadow-md text-sm font-bold rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all flex items-center cursor-pointer"
        >
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
          JSON
        </button>
