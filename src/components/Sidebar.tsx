  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col h-full hidden md:flex min-h-screen">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        <Link href="/" className="flex items-center px-4 py-3 bg-gray-800 text-white rounded-lg transition-colors">
        ...
        <Link href="#" className="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors">
