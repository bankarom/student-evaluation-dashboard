        ...
        <div className="max-w-5xl mx-auto space-y-6">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 focus:ring-4 focus:ring-blue-100 disabled:bg-blue-400 transition-all flex items-center"
            >
              {isGenerating ? (
                <>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-gradient-to-r from-gray-900 to-indigo-900 rounded-xl p-8 text-white flex justify-between items-center shadow-lg">
                ...
                <button 
                  ...
                  className="px-6 py-3 bg-white text-indigo-900 font-bold rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
                >
                  Download PDF
                </button>
              </div>
